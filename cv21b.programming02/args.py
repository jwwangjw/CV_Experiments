...
val_file = './val_cut.txt'  # The path of the validation txt file.
restore_path = './checkpoint/best_model_Epoch_20_step_123626_mAP_0.1232_loss_200.4872_lr_0.0001'  # The path of the weights to restore.
...
val_evaluation_epoch = 4  # Evaluate on the whole validation dataset after some epochs. Set to None to evaluate every epoch.
save_epoch = 4  # Save the model after some epochs.
batch_norm_decay = 0.99  # decay in bn ops
weight_decay = 5e-4  # l2 weight decay
global_step = 123626  # used when resuming training
